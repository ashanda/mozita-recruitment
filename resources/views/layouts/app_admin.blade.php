        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="#" data-toggle="dropdown">
              ...
              <span class="count">{{ count(notificatio_read()) }}</span>
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              <p class="mb-0 font-weight-normal float-left dropdown-header">Notifications</p>
              @foreach ( notificatio_read() as $notification)
                 <a class="dropdown-item preview-item" href="{{ route('notification.edit',$notification->id) }}">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <!-- partial:partials/_footer.html -->
        <footer class="footer">
            ...
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <?php echo date("Y"); ?>.  <a href="https://mozita.digital/" target="_blank">Mozita Digital</a> . All rights reserved.</span>
